...
class MIDIChord(object):
    ...
    def note2pianoroll_chords(self, notes, max_tick, ticks_per_beat):
        return notes2pianoroll(
    ...
    def find_chord(self, pianoroll):
        chroma = tochroma(pianoroll=pianoroll)
    ...
    def extract(self, notes):
        ...
        ticks_per_beat = 480
        pianoroll = self.note2pianoroll_chords(
            notes=notes, 
            max_tick=max_tick, 
            ticks_per_beat=ticks_per_beat)
